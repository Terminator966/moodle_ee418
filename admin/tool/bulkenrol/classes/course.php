...
class tool_bulkenrol_course {
    ...
    public function __construct($mode, $updatemode, $rawdata, $defaults = array(), $importoptions = array()) {
        ...
        } else if ($updatemode !== tool_bulkenrol_processor::UPDATE_NOTHING &&
    ...
    public function can_create() {
        return in_array($this->mode, array(tool_bulkenrol_processor::MODE_CREATE_ALL,
            tool_bulkenrol_processor::MODE_CREATE_NEW,
            tool_bulkenrol_processor::MODE_CREATE_OR_UPDATE)
        );
    }
    ...
    public function can_update() {
        return in_array($this->mode,
                array(
                    tool_bulkenrol_processor::MODE_UPDATE_ONLY,
                    tool_bulkenrol_processor::MODE_CREATE_OR_UPDATE)
                ) && $this->updatemode != tool_bulkenrol_processor::UPDATE_NOTHING;
    }
    ...
    public function can_use_defaults() {
        return in_array($this->updatemode, array(tool_bulkenrol_processor::UPDATE_MISSING_WITH_DATA_OR_DEFAUTLS,
