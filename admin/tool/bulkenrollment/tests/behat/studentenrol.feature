...
Feature: An admin can update students enrolled in any given course using a CSV file
  In order to update courses enrolments using a CSV file
  As an admin
  I need to be able to upload a CSV file with fields for student username, class id, and their role in the course.
