@block @block_upcoming_events2 @javascript
Feature: The timeline block allows users to see upcoming courses
  ...
  Scenario: Next 30 days in course view
    ...
    Then I should see "Course 1" in the ".block_upcoming_events2 [data-region='view-courses']" "css_element"
    And I should see "Course 2" in the ".block_upcoming_events2 [data-region='view-courses']" "css_element"
    And I should see "Show more courses" in the "Timeline" "block"
    And I click on "Show more courses" "button" in the "Timeline" "block"
    And I should see "Course 4" in the ".block_upcoming_events2 [data-region='view-courses']" "css_element"
