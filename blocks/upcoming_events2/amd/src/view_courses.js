...
[
    ...
    'core/templates',
    'block_upcoming_events2/event_list',
...
function(
    ...
    var TEMPLATES = {
        COURSE_ITEMS: 'block_upcoming_events2/course-items',
    ...
    var loadMoreCourses = function(root, append = false) {
        const pendingPromise = new Pending('block/upcoming_events2:load-more-courses');
