 ...
 * given day range.
 *
 * @module     block_upcoming_events2/event_list
...
[
    ...
    'core/str',
    'core/user_date',
    'block_upcoming_events2/calendar_events_repository',
    'core/pending'
],
function(
    $,
    ...
    var TEMPLATES = {
        EVENT_LIST_CONTENT: 'block_upcoming_events2/event-list-content',
        MORE_ACTIVITIES_BUTTON: 'block_upcoming_events2/event-list-loadmore',
    ...
    var init = function(root, additionalConfig = {}) {
        const pendingPromise = new Pending('block/upcoming_events2:event-init');
        root = $(root);
